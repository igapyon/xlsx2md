...
図形のテキスト出力が欲しい場合には、`--include-shape-details` を付けて実行します。

```bash
npm run cli -- ./tests/fixtures/shape/shape-basic-sample01.xlsx --include-shape-details
```
